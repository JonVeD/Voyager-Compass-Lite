...
nc_dialog_controls = [
  ...
  ["(uiNamespace getVariable 'nc_dialogDisplay') closeDisplay 2"]],
	...
	[[/*range*/0.10,0.55, ncW], "folder set [2, (_this select 1)]; ncW = (_this select 1);
  ...
  GTX_groupBackground ctrlSetPosition [(0.5 * safezoneW + safezoneX) - (ncW  * safezoneW),0.01111 * safezoneH + safezoneY+ 0.01,(ncW * safezoneW)*2,10 * safezoneH];
  GTX_groupBackground ctrlCommit 0;
